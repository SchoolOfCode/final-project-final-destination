  ...
  return (
      <div className={styles.container}>
        ...
        <div className={styles.hostInfo}>
          <Image className={styles.coachImg}
          src ="/coach.jpg"
          alt= "Football-coach"
          width={100}
          height={90}
          ...
          <div className={styles.hostText}>
            <h4>John Doe</h4>
          <p>I am an experienced football coach, fully DBS-checked and first aid trained. With years of experience working with children, I hope to brings a combination of skill and enthusiasm to every session. I am also dedicated to creating a safe and enjoyable environment where your child can learn, improve, and have fun playing football.</p>
          </div>
        </div>
